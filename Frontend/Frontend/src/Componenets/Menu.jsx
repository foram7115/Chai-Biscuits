...
const snackItems = [
  ...
  { name: "Butter Croissant", description: "Flaky & buttery", price: 120, image: Croissant },
  { name: "Chocolate Muffin", description: "Soft and fresh", price: 100, image: Muffin },
  { name: "Strawberry Donut", description: "With choco glaze", price: 110, image: Donut },
  { name: "Burger", description: "Crispy and cheesy", price: 130, image: Snack1 },
  { name: "Banana Fries", description: "Golden and crisp", price: 110, image: Snack2 },
  { name: "French Fries", description: "Spicy veg-filled pastry", price: 90, image: Snack3 },
  { name: "Rumbles", description: "Crunchy and sweet", price: 80, image: Snack4 },
  { name: "Naachos", description: "Paneer and veggies", price: 160, image: Snack5 },
